...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let modules: [String] = ["Toast", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser", "AssetBrowser"]
        let names: [String] = ["Toast 提示弹窗", "资源浏览器", "资源选择器", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器", "分页控制器", "菜单视图", "请求控制器"]
