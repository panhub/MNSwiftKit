...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.subspec 'Transitioning' do |tr|
    #tr.name = 'MNSwiftKitTransitioning'
  ...
  s.subspec 'AnimatedImage' do |ani|
    #ani.name = 'MNSwiftKitAnimatedImage'
