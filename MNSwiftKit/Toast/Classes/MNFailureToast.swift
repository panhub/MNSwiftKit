...
public class MNFailureToast: NSObject, MNToastBuilder {
    ...
    public lazy var activityView: UIView = {
        ...
        let activityView = UIView(frame: CGRect(origin: .zero, size: CGSize(width: 35.0, height: 34.0)))
        
        let lineWidth: CGFloat = 2.5
        
        let rect = activityView.bounds.inset(by: UIEdgeInsets(top: lineWidth/2.0, left: lineWidth/2.0, bottom: lineWidth/2.0, right: lineWidth/2.0))
