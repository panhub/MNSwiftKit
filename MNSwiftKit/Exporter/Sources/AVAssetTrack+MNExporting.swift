...
extension AVAssetTrack {
    ...
    /// 视频尺寸
    public var naturalSizeOfVideo: CGSize {
    ...
    /// 视频变换
    public var preferredTransformOfVideo: CGAffineTransform {
    ...
    public func transform(withRenderSize renderSize: CGSize) -> CGAffineTransform {
    ...
    public func transform(withRect outputRect: CGRect, renderSize: CGSize) -> CGAffineTransform {
        let naturalSize = naturalSizeOfVideo
        guard naturalSize != .zero else { return .identity }
        var angle: Double = 0.0
