...
//  MNFoundation
//
//  Created by MNFoundation on 2022/2/27.
//  截取字符串
...
extension String {
    ...
    /// - Returns: 截取后的字符串
    public func substring(fromIndex location: Int) -> String {
    ...
    /// - Returns: 截取后的字符串
    public func substring(toIndex location: Int) -> String {
    ...
    ///   - length: 长度
    /// - Returns: 截取后的字符串
    public func substring(location: Int, count length: Int) -> String {
