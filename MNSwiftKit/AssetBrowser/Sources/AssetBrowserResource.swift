...
public class AssetBrowserResource {
    ...
    private class var bundle: Bundle {
        ...
        if let url = Bundle(for: AssetBrowserResource.self).url(forResource: "MNSwiftKit_AssetBrowser", withExtension: "bundle", subdirectory: "Frameworks/MNSwiftKit.framework"), let bundle = Bundle(url: url) {
            return bundle
        }
