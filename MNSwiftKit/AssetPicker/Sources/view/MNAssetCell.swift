...
class MNAssetCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        // 顶部阴影
        topShadow.image = PickerResourceLoader.image(named: "top_shadow")
        ...
        // 底部阴影
        bottomShadow.image = PickerResourceLoader.image(named: "bottom_shadow")
        ...
        cloudView.image = PickerResourceLoader.image(named: "cloud")?.mn_picker.renderBy(color: .white.withAlphaComponent(0.85))
        ...
        let previewBadge = UIImageView(image: PickerResourceLoader.image(named: "preview")?.mn_picker.renderBy(color: .white.withAlphaComponent(0.85)))
        ...
        // 资源类型
        badgeView.setImage(PickerResourceLoader.image(named: "video")?.mn_picker.renderBy(color: UIColor(red: 251.0/255.0, green: 251.0/255.0, blue: 251.0/255.0, alpha: 1.0)), for: .normal)
        badgeView.setImage(PickerResourceLoader.image(named: "livephoto")?.mn_picker.renderBy(color: UIColor(red: 251.0/255.0, green: 251.0/255.0, blue: 251.0/255.0, alpha: 1.0)), for: .highlighted)
        badgeView.setImage(PickerResourceLoader.image(named: "gif")?.mn_picker.renderBy(color: UIColor(red: 251.0/255.0, green: 251.0/255.0, blue: 251.0/255.0, alpha: 1.0)), for: .selected)
